...
//		log.info(mv.getModel().get("list"));
	...
	*/
	...
	public void testListPaging() throws Exception {
		...
		MvcResult res = mockMvc.perform(MockMvcRequestBuilders.get("/board/list").param("pageNo", "2").param("amount", "10")).andReturn();
	...
	public void testModify() throws Exception {
		...
		MvcResult res = mockMvc.perform(MockMvcRequestBuilders.post("/board/modify").param("bno", key+"")
				.param("title", "test modify new title")
				.param("content", "test modify new content").param("writer", "user00")).andReturn();
		FlashMap map = res.getFlashMap();
		String viewName = res.getModelAndView().getViewName();
	...
	public void testRemove() throws Exception {
		...
		int before = mapper.getList().size();
		MvcResult res = mockMvc.perform(MockMvcRequestBuilders.post("/board/remove").param("bno", key + "")).andReturn();
		int after = mapper.getList().size();
